    ...
    <footer className="w-full bg-[#232323] border-t border-[#333] py-6 px-4 flex flex-col items-center justify-center gap-6 text-gray-200 text-base mt-auto text-center">
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full">
        ...
        <div className="flex items-center gap-5 mt-4 md:mt-0 w-full md:w-auto justify-center">
          <a href="https://t.me/bazaraVPN" className="hover:text-[#fd6a32]" aria-label="Telegram" target="_blank" rel="noopener">
            <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M22 4L12 20l-3-7-7-3z"/></svg>
          </a>
          <a href="https://www.instagram.com/bazaravpn/" className="hover:text-[#fd6a32]" aria-label="Instagram" target="_blank" rel="noopener">
          ...
          <a href="https://www.youtube.com/@BazaraVPN" className="hover:text-[#fd6a32]" aria-label="YouTube" target="_blank" rel="noopener">
          ...
          <a href="https://www.tiktok.com/@bazaravpn1?lang=ru-RU" className="hover:text-[#fd6a32]" aria-label="TikTok" target="_blank" rel="noopener">
