    ...
    <LanguageProvider>
      ...
      <main className="min-h-screen flex flex-col items-center justify-center pt-32 pb-16 bg-[#181818]">
        <div className="w-full max-w-3xl mx-auto flex flex-col items-center animate-fade-in">
          ...
          <a href="https://github.com/hiddify/hiddify-next/releases" target="_blank" className="block w-full text-center bg-gradient-to-r from-[#fd6a32] to-purple-500 hover:from-[#fd6a32] hover:to-purple-600 text-white font-bold py-4 rounded-2xl text-xl shadow-xl transition mb-8">
