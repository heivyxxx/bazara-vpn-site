...
const texts = {
  ru: {
    ...
    step1: "Скачай <b>Hiddify Next</b> для Android по кнопке ниже или в Google Play.",
    ...
    help1: "Проверь разрешения на интернет и VPN для Hiddify.",
  ...
  en: {
    ...
    step1: "Download <b>Hiddify Next</b> for Android using the button below or from Google Play.",
    ...
    help1: "Check internet and VPN permissions for Hiddify.",
...
export default function AndroidInstallPage() {
  ...
  const t = texts[lang];
  return (
    <div className="min-h-screen flex flex-col items-center justify-center pt-32 pb-16 bg-[#181818]">
      <div className="w-full max-w-3xl mx-auto flex flex-col items-center animate-fade-in">
        {/* Баннер */}
        <div className="relative flex flex-col items-center mb-8">
          <Image src="/assets/android.png" alt="Android logo" width={180} height={180} className="mb-4 mx-auto" />
        ...
        <a href="https://play.google.com/store/apps/details?id=app.hiddify.com" target="_blank" className="block w-full text-center bg-gradient-to-r from-orange-500 to-purple-500 hover:from-orange-600 hover:to-purple-600 text-white font-bold py-4 rounded-2xl text-xl shadow-xl transition mb-8">
