...
const ReviewCard = ({ avatar, name, rating, text, date }: ReviewCardProps) => (
  <div className="bg-[#18181b] rounded-2xl shadow-xl p-8 flex flex-col items-start min-w-[320px] max-w-[370px] mx-auto review-card-3d-anim">
    ...
    <section className="max-w-5xl mx-auto my-16 px-4">
      <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-4 sm:gap-0 mb-8">
        ...
        <div className="flex w-full sm:w-auto justify-center sm:justify-start">
          <Link 
            href="/reviews" 
            className="font-bold py-3 px-6 rounded-xl text-lg transition-all w-full sm:w-auto text-center bg-[#fd6a32] hover:bg-[#e65a1e] text-white"
      ...
      {/* Удаляю блок: */}
      {/* <div className="flex items-center gap-2 w-full mb-8"> ... </div> */}
