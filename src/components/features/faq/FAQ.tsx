...
const FAQItem = ({ question, answer, isOpen, onClick }: FAQItemProps) => (
  <div className="border-b border-[#333] last:border-b-0">
    ...
    >
      ...
      <svg
        className={`w-6 h-6 text-[#FF944D] transform transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
...
export const FAQ = () => {
  ...
  return (
    <section className="max-w-4xl mx-auto my-10 md:my-20 px-2 sm:px-4">
      <h2 className="text-2xl md:text-3xl font-bold text-[#FF944D] mb-6 md:mb-10 text-center">
        {t.title}
      </h2>
